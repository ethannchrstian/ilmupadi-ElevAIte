...
function App() {
  ...
  const handleSubmit = async (file) => {
    ...
    try {
      ...
      // Mock predictions for demo tapi ini juga nanti diubah harusnya
      ...
      <div className="bg-white/70 backdrop-blur-sm border-b border-green-200/50 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Alat Deteksi Padi</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <p className="text-lg font-medium text-gray-700">
                        Letakkan gambar Anda di sini atau klik untuk memilih
                      </p>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-green-100 p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Cara Kerjanya</h3>
                ...
                <div className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">Analisis berhasil</h3>
                      ...
                      {status.isHealthy ? (
                        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                          <h4 className="font-medium text-green-800 mb-2">Berita baik! 🎉</h4>
