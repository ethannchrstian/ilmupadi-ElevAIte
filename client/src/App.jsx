...
import {Leaf, Activity, MessageSquare, Newspaper, User, LogOut, Eye, EyeOff, Menu, X} from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
              ...
              <div className="min-w-0">
                <h1 className="text-sm sm:text-xl lg:text-2xl font-bold text-gray-800 truncate">Alat Pendeteksi Penyakit Padi</h1>
                ...
                {navigationItem.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg transition-all touch-manipulation ${
                        isActive
